  ...
  try {
    const completion = await groq.chat.completions.create({
      messages: [
        {
          role: 'system',
          content: 'You are an AI assistant specialized in analyzing patent descriptions, identifying key contributions, and potential contributors. Use the exact wording from the patent description when describing contributions.',
        },
